...
2. Clone the repository:
 ```console 
https://github.com/Kazi-Mostafa-Moymim/Api_Testing_on_Restful_Booker.git
```
...
```console 
newman run Restful-broker.postman_collection.json -e Restful-broker.postman_environment.json 
```
- Run Command for Report: 
```console 
newman run Restful-broker.postman_collection.json -e Restful-broker.postman_environment.json -r cli,htmlextra
```
